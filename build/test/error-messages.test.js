...
describe('error-messages', () => {
  ...
  it('should return message for length', () => {
    errorMessages('length', 'Password', { min: 8 }).should.eql('Password should be a minimum of 8 characters');
    errorMessages('length', 'Password', { min: 8, max: 12 }).should.eql('Password should be a minimum of 8 and a maximum of 12 characters');
