...
export default (schema, customMessages) => {
  const fields = Object.keys(schema)
  const validate = buildValidationFn(schema, customMessages)
  return {
    fields,
    validate
  }
...
function buildValidationFn(schema, customMessages) {
  var errorMessages = customMessages || defaultErrorMessages
